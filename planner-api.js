...
async function validateGeneratedPlan(plan,next,locateDay,spatialValidator){
  ...
  await spatialValidator(plan,next.slots.destination,rule.spatialDiversity,locateDay);
}
